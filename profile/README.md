...
This project adds a lightweight publishing workflow to the Nextcloud Collectives app, enabling users to turn collaboratively managed cloud content into static websites and publish them online with a few clicks.
